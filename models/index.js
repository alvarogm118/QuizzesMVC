...
user.hasMany(quiz, {foreignKey: 'authorId'}); //Esto sirve si se quiere poner quiz.author saldra y no
quiz.belongsTo(user, {as: 'author', foreignKey: 'authorId'}); // quiz.authorId, q da el id y no el author
